# -*- coding: utf-8 -*-
"""Lab_5_Differentiation_and_Richardson_Extrapolation (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WWhj3sgdakcFkvNsu5AG5kAVnf_1Rzit

Make sure you remove `raise NotImplementedError()` and fill in any place that says `# YOUR CODE HERE`, as well as your `NAME`, `ID`, and `SECTION` below:
"""

NAME = "Khandoker Md. Ragib Ahsan"
ID = "22301202"
SECTION = "21"
...
c1 = dh1(z,h,x)
print(c1)
c2= forward_diff(z,h,x)
print(c2)
c3 = backward_diff(z,h,x)
print(c3)
c4 = central_diff(z,h,x)
print(c4)